                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
                        <li className="nav-item _header_nav_item">
                            <NavLink  to="/" className="nav-link _header_nav_link _header_nav_link_active"  aria-current="page">
                        ...
                        <li className="nav-item _header_nav_item">
                            <NavLink to="/friendhome" className="nav-link _header_nav_link" aria-current="page">
                        ...
                        <li className="nav-item _header_nav_item">
                            ...
                            >
                            <span onClick={() => setVisible(!visible)} id="_notify_btn" className="nav-link _header_nav_link">
                                        <div className="_header_notify_btn">
                                        ...
                                        {visible &&
                                            ...
                                            <div className="_notifications_content">
                                                ...
                                                <div onClick={() => setOpen(!isOpen)} className="_notification_box_right">
                                                    <Link to="/allnotification" className="_notification_box_right_link">
                                                        <span>See All</span>
                                                    </Link>
                                                </div>
                                            </div>
                        ...
                        <li className="nav-item _header_nav_item">
                            <NavLink className="nav-link _header_nav_link" aria-current="page" to="/message">
                                    ...
                                    <div className="_layout_mode_swithing_btn">
                                        <button type="button" className="_layout_swithing_btn_link">
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="8" height="12" fill="none" viewBox="0 0 8 12">
                                                <path fill="#fff" d="M1.15 6.986l-.489.107.489-.107zm6.046 3.886l.198-.462-.198.462zm-.724-9.9l-.489.106.489-.106zM6.325.71L6.667.34l-.342.37zm-.508 2.008a4.848 4.848 0 00-1.182 4.276l-.977.213a5.862 5.862 0 011.434-5.169l.725.68zM4.635 6.993c.328 1.603 1.4 2.841 2.76 3.417l-.397.925c-1.651-.7-2.945-2.2-3.34-4.129l.977-.213zM1.638 6.88c.53 2.58 2.977 4.205 5.445 3.667l.201.98c-3.033.661-5.988-1.34-6.623-4.434l.977-.213zm3.54-5.626C2.71 1.792 1.11 4.3 1.638 6.88l-.977.213C.027 3.999 1.944.936 4.977.274l.201.98zm2.216 9.156a.59.59 0 01-.11 1.117l-.2-.98a.426.426 0 00-.332.383c-.01.155.07.33.246.405l.396-.925zM5.092 2.037c.364-.391.61-.658.764-.858.077-.1.11-.158.124-.188.013-.029-.012.011.003.087l.978-.212a.862.862 0 01-.071.526c-.061.137-.151.27-.247.394-.19.247-.477.556-.826.931l-.725-.68zM4.977.274C5.315.2 5.62.133 5.86.114c.24-.02.556-.008.807.226l-.684.738c.062.058.108.021-.053.034-.159.013-.384.061-.752.142l-.2-.98zm1.006.804L6.667.34a.99.99 0 01.294.526l-.978.212z"/>
                                            </svg>
